...
## Project Structure
    ...
    ├── testapiautosetting_125887  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125887`
...
2. Clone this repo and `cd testapiautosetting_125887`
